...
<head>
    ...
    <title>Nuevo Cliente - AgriManage</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="../../controllers/ClienteController.php?action=store" method="POST" id="form-cliente">
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control" name="telefono" pattern="[0-9]{9,10}">
                                </div>
                                <div class="col-md-6">
            ...
            <div class="col-md-4">
                <div class="card bg-light">
                    <div class="card-body">
                        ...
                        <p class="small">La cédula se valida automáticamente con el algoritmo del Registro Civil.</p>
                    </div>
                </div>
            </div>
        </div>
